...
len=x=>l(x.body).count||(l(x.body).parent&&(l(x.body).parent.count||(l(x.body).parent.source&&l(x.body).parent.source.length)))||(l(x.body).source&&l(x.body).source.length)||0
tru=x=>(
  {
    type:'bool',
    body:
